                ...
                <table className='table-auto w-full'>
                    ...
                    <tbody>
                        <tr>
                            <td>1</td>
                            <td>Product Name</td>
                            <td><img width={'70px'} height={'70px'} src="https://media.istockphoto.com/id/1219014036/video/shopping-grocery-products-stock-animation-alpha-matte.jpg?s=640x640&k=20&c=tlDAQzl1lr4ynJfD4wjVw9WgcQT9gcTry5AQ0JMgcK8=" alt="" /></td>
                            <td>
                                <div className='flex'>
                                    <button className='font-bold'>-</button>
                                    <input style={{width:'70px'}} type="text" className='border p-1 rounded mx-2' value={2} readOnly />
                                    <button className='font-bold'>+</button>        
                                </div>
                            </td>
                            <td>$100</td>
